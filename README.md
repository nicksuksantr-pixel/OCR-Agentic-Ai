...
- **Jobs** — history of scans, per-job detail, sections flagged for AI Boost.
...
- **Settings** — Gemini key (stored in `.env`), model, daily request cap, AI Boost on/off, inbox watcher on/off, API on/off + port, tray on/off.
